...
select o.custid, o.orderid, o.orderdate, o.empid from sales.orders o where o.custid = (select top (1) custid from sales.orders group by custid order by count(orderid) desc);
...
select o.orderdate from sales.orders o where o.orderdate >= '2016-05-01';
