...
select empid, max(orderdate) as orderdate from sales.Orders group by empid;
...
select empid, max(orderdate) as dateOfLastActivity from sales.Orders group by empid;

select o.empid, max(o.orderdate), o.orderid, o.custid from Sales.Orders o inner join
(select empid, max(orderdate) as orderdate from sales.Orders group by empid) c
on o.empid = c.empid and o.orderdate = c.dateOfLastActivity group by o.empid, o.orderid, o.custid;
...
select v.empid, v.orderyear, v.sumQty 
